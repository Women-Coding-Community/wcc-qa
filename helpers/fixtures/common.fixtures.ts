...
export const test = base.extend<TestFixtures, WorkerFixtures>({
	...
	mentorshipAdminContext: async ({ contextForRole }, use) => use(await contextForRole("mentorshipAdmin")),

	authApi: async ({ authRequest }, use) => use(new APIService(authRequest)),

	apiForRole: async ({ contextForRole }, use) => use(async (role: Role) => new APIService(await contextForRole(role))),
	...
	mentorshipAdminApi: async ({ mentorshipAdminContext }, use) => use(new APIService(mentorshipAdminContext)),
});
