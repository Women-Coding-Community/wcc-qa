...
**Status:** Not done :hourglass_flowing_sand:

> Note: The "Jobs" link does not exist on the live site at the time of writing.
...
> Note: There is no "Find a Mentor" button on the live home page; the equivalent CTA is the "Check our mentors" link (covered by MENT-002).
...
1. Launch the application in the browser and go to `/mentorship`.
2. Open the "Mentorship" dropdown in the header navigation.
3. Click each item in the dropdown one by one.
4. After each click, verify both the URL and the page's main heading to confirm the page actually loaded.

**Expected Result:**
On clicking each option:

- **Overview** → URL `/mentorship`, heading "Mentorship Programme" visible
- **Mentors** → URL `/mentorship/mentors`, heading "Meet Our Mentors" visible
- **Study Groups** → URL `/mentorship/study-groups`, heading "Study Groups" visible
- **Resources** → URL `/mentorship/resources`, heading "Mentorship Resources" visible
- **Code of Conduct** → URL `/mentorship/code-of-conduct`, heading "Mentorship Code of Conduct" visible
- **FAQs** → URL `/mentorship/faqs`, heading "Mentorship FAQ" visible
- **Long-Term Timeline** → URL `/mentorship/long-term-timeline`, heading "Long-Term Mentorship Timeline" visible
- **Ad-Hoc Timeline** → URL `/mentorship/ad-hoc-timeline`, heading "Ad-Hoc Mentorship Timeline" visible
